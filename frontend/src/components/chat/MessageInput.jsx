...
const MessageInput = ({ onSendMessage, onTyping, replyTo, onCancelReply }) => {
  ...
  return (
    <div className="message-input-box relative bg-white dark:bg-[#1A2A32] border-t border-gray-200 dark:border-gray-700" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 80px)' }}>
      {/* ✅ Reply Preview */}
      {replyTo && (
